      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <span class="red-subtitle">Подбор материалов, технический надзор и еще 12 причин вызвать нашего специалиста для консультации</span>
            <div class="clearfix"></div>
            <div class="col-md-3 icon">
              <img src="<?php echo get_template_directory_uri(); ?>/img/tec-control.png" alt="">
              <p>Независимый технический надзор</p>
            </div>
            <div class="col-md-3 icon">
              <img src="<?php echo get_template_directory_uri(); ?>/img/team.png" alt="">
              <p>Опытная команда без случайных людей</p>
            </div>
            <div class="col-md-3 icon">
              <img src="<?php echo get_template_directory_uri(); ?>/img/speed.png" alt="">
              <p>Стартуем работы в день подписания договора</p>
            </div>
            <div class="col-md-3 icon">
              <img src="<?php echo get_template_directory_uri(); ?>/img/cards-pay.png" alt="">
              <p>Поэтапная оплата только за результат</p>
            </div>
            <div class="clearfix"></div>
            <a href="#" class="button red-button">Узнать все 23 преимущества</a>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /section -->
